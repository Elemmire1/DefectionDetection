...
# 保存模型
os.makedirs("checkpoints" + str(training_catagory), exist_ok=True)
torch.save(model.state_dict(), "modelcnn" + str(training_catagory) + ".pth")
torch.save({
    'model_state_dict': model.state_dict(),
    'optimizer_state_dict': optimizer.state_dict(),
}, "checkpoints"+ str(training_catagory) +"/checkpoint" + str(training_catagory) + ".pth")
print("模型已保存")