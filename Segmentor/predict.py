...
def main():
    ...
    for cls in range(1, 5):
        ...
        parameters = "loss_0.5_dataenhancement_yes"
        classes = 1  # 钢铁缺陷的类别数
        ...
        if Kaggle == True:
            model_path = f"/kaggle/input/ablation/{model_type}_{encoder_name}_{parameters}_class_{cls}.pth"
        else:
            model_path = f"models/{model_type}_{encoder_name}_{parameters}_class_{cls}.pth"
        ...
        df = pd.read_csv(f"../Classifier/prediction_task.csv")
        test_imgs = []
